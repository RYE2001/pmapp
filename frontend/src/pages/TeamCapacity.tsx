...
export default function TeamCapacity() {
  ...
  const totals = useMemo(() => ({
    ...
    contextSwitching: data?.people.filter((person) => person.contextSwitching).length ?? 0,
  }), [data]);
